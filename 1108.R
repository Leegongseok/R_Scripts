...
url=paste0(api,"?servicekey",api_key, 
           ...
           "&numofRows",numofRows, 
           "&pageNo",pageNo, "& itemcode",itemcode,
           "&dataGubun",dataGubun, "&searchCondition",searchCondition
...
map = st_read("D:/R_Data/R_Script/행정경계데이터셋/Z_NGII_N3A_G0010000.shp" , options = "ENCODING=EUC-KR")
map
...
ggplot() +
  ...
  labs(title="PM10 농도도 분포", x="경도", y="위도")
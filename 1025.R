...
url="D:/R_Data/R_Script/wetScraping/영화1.html"
...
url="D:/R_Data/R_Script/wetScraping/영화2.html"
html=read_html(url,encoding = "utf-8")
html
...
url="D:/R_Data/R_Script/wetScraping/영화3.html"
html=read_html(url,encoding = "utf-8")
html

#현재상영중인(클래스가 title)영화제목만 추출
movie1=html_nodes(html,".title1")%>%
  html_text()

movie1

#현재상영중인(클래스가 title)영화예매율만 추출
movie1=html_nodes(html,".rate1")%>%
  html_text()

movie1

#개봉 예정중인(클래스가 title2)영화제목만 추출
movie1=html_nodes(html,".title2")%>%
  html_text()

movie1

#개봉 예정중인(클래스가 title2)영화예매율만 추출
